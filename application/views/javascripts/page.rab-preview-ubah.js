...
$(() => {
	...
	const refreshTotal = (ubah = '') => {
		...
		// view value
		$("#" + ubah + "total_harga_ringgit").val('RM ' + window.apiClient.format.format_ringgit(ringgit_total))
		$("#" + ubah + "total_harga_rupiah").val('Rp ' + window.apiClient.format.format_ringgit(rupiah_total))
	...
	$('#harga_ringgit').on('change', function () {
		...
		$.ajax({
			...
			$("#total_harga_ringgit").val('RM ' + window.apiClient.format.format_ringgit(value))
			$("#total_harga_rupiah").val('Rp ' + window.apiClient.format.format_ringgit(data.rupiah))
	...
	$('#ubah-harga_ringgit').on('change', function () {
		...
		$.ajax({
			...
			$("#ubah-total_harga_ringgit").val('RM ' + window.apiClient.format.format_ringgit(value))
			$("#ubah-total_harga_rupiah").val('Rp ' + window.apiClient.format.format_ringgit(data.rupiah))
...
const Ubah = (id) => {
	$.ajax({
		...
		$("#ubah-total_harga_ringgit").val("RM " + window.apiClient.format.format_ringgit(data.total_harga_ringgit));
		$("#ubah-val_total_harga_rupiah").val(data.total_harga_rupiah);
		$("#ubah-total_harga_rupiah").val("RM " + window.apiClient.format.format_ringgit(data.total_harga_rupiah));
