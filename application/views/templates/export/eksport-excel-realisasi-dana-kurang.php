...
<body>
    ...
    header("Content-Disposition: attachment; filename=Realisasi Dana Kurang $cabang ($npsn).xls");

    ?>
    <div class="container">
        <div class="page-header text-center">
            <h4>DATA REALISASI DANA KURANG <?= $npsn; ?>(<?= $cabang; ?>)</h4>
        </div>
        <table border="1">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="str"><?= number_format($d['sisa_ringgit'], 0, ',', ','); ?></td>
                        <td class="str"><?= number_format($d['sisa_rupiah'], 0, '.', '.'); ?></td>
