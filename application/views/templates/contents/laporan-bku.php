          ...
          <div>
            ...
            <div class="widget-body">
              ...
              <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                <thead>
                  <tr>
                    <th data-class="expand" style="width: 7%;"> NPSN</th>
                    <th data-class="expand" style="width: 25%;"> Cabang</th>
                    <th data-class="expand" style="width: 7%;"> Tanggal</th>
                    <th data-class="expand" style="width: 8%;"> Kode</th>
                    <th data-class="expand"> Keterangan</th>
                    <th data-class="expand" style="width: 10%;"> RM</th>
                    <th data-class="expand" style="width: 10%;"> Rp</th>
                  </tr>
                </thead>
