<div id="content">
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
      <div class="row">
        <div class="col-md-3">
          <select class="form-control" name="filter_data_cabang" id="filter_data_cabang" style="display: none;">
            <option value="<?= $cabangdetail['id'] ?>"><?= $cabangdetail['kode'] ?></option>
          </select>
        </div>
        <div class="col-md-2">
...
<script>
  let global_id_cabang = "<?= $cabangdetail['id'] ?>";
</script>