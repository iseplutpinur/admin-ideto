					...
					<div>
						...
						<div class="widget-body">
							<form action="realisasi/simpanDanaSisa" method="POST">
								...
								<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
									...
									<tbody>
										<?php foreach ($dana_sisa as $q) : ?>
											<tr>
												<td><input name="id_realisasi[]" value="<?= $q['id_realisasi'] ?>" type="checkbox" class="check" data-ringgit="<?= $q['sisa_ringgit'] ?>" data-id_rab="<?= $q['id'] ?>" data-rupiah="<?= $q['sisa_rupiah'] ?>"></td>
												<td><?= $q['kodes'] ?></td>
								...
								<div class="row">
									<div class="col-md-12">
										<a href="#" onclick="ubah(this)" class="btn btn-default" id="btn-ubah" disabled> Alihkan</a>
									</div>
								</div>
							</form>
						</div>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="kode" placeholder="" readonly />
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="harga_ringgit" placeholder="" value="0" required readonly />
												...
												<div class="row">
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="non-rab-keterangan" placeholder="" />
														</div>
													</div>
												</div>
											</div>
