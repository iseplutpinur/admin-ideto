										...
										<div class="col-md-8 col-sm-12 col-xs-12">
											<div class="product-deatil" style="border-bottom: none;">
												...
												<p class="price-container">
													<span style="font-family: sans-serif; font-size: 16px; line-height: 20px; color:black">RM <?= $this->libs->ringgit_non($rab['total_harga_ringgit']) ?></span><br>
													<span style="font-family: sans-serif; font-size: 16px; line-height: 20px; color:black">RP <?= $this->libs->ringgit_non($rab['total_harga_rupiah']) ?></span>
												</p>
											</div>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-md-8 col-sm-12 col-xs-12">
											<div class="product-deatil" style="border-bottom: none;">
												...
												<p class="price-container">
													<span style="font-family: sans-serif; font-size: 16px; line-height: 20px; color:black">RM <?= $this->libs->ringgit_non($realisasi['harga_ringgit']) ?></span><br>
													<span style="font-family: sans-serif; font-size: 16px; line-height: 20px; color:black">RP <?= $this->libs->ringgit_non($realisasi['harga_rupiah']) ?></span>
												</p>
											</div>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-md-8 col-sm-12 col-xs-12">
											<div class="product-deatil" style="border-bottom: none;">
												...
												<p class="price-container">
													<span style="font-family: sans-serif; font-size: 16px; line-height: 20px; color:black">RM <?= $this->libs->ringgit_non($saldo['total_ringgit']) ?></span><br>
													<span style="font-family: sans-serif; font-size: 16px; line-height: 20px; color:black">RP <?= $this->libs->ringgit_non($saldo['total_rupiah']) ?></span>
												</p>
											</div>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-md-8 col-sm-12 col-xs-12">
											<div class="product-deatil" style="border-bottom: none;">
												...
												<p class="price-container">
													<span style="font-family: sans-serif; font-size: 16px; line-height: 20px; color:black">RM <?= $this->libs->ringgit_non($dialihkan['jumlah_ringgit']) ?></span><br>
													<span style="font-family: sans-serif; font-size: 16px; line-height: 20px; color:black">RP <?= $this->libs->ringgit_non($dialihkan['jumlah_rupiah']) ?></span>
												</p>
											</div>
										</div>
									</div>
